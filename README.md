...
If your pages share a common header and menu, the RetiSkip page can show them too. Create `site_parts.py` in your scripts folder (`~/scripts` by default) with a `print_top()` function that prints them:
